from .filter_keyword import filter_string
...
class ShoppingOnlineLocation:
    def __init__(self, location: str, keyword: str, page: str,MinMaxPrice: str) -> None:
        self.location = location
        self.keyword = keyword
        self.page = page
        self.MinMaxPrice=MinMaxPrice
    ...
    def get_base_url(self) -> str:
        match self.location:
            ...
            case "lazada":
                ...
                base_url = "https://www.lazada.com.my/tag/{0}/?page={1}".format(filter_keyword, self.page)
                return base_url
            case "daraz":
                filter_keyword = filter_string(self.keyword, "-")
                base_url = "https://www.daraz.pk/catalog/?q={0}&page={1}".format(filter_keyword, self.page)
                if self.MinMaxPrice !='':
                    base_url = "https://www.daraz.pk/catalog/?q={0}&page={1}&price={2}".format(filter_keyword, self.page,self.MinMaxPrice)
                print(base_url)
                return base_url
            # case "amazon":
            #     filter_keyword = filter_string(self.keyword, "+")
